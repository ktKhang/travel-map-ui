...
class Albums extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            columns: [{
                ...
                dataField: 'photosNumber',
                text: 'Photo number',
                sort: true
            }, {
                dataField: 'albumStatus',
                text: 'Status',
                sort: true
            }, {
                ...
                dataField: 'uid',
                text: 'Action',
                formatter: props => <this.Delete deleteFunc={this.deleteAlbum.bind(this, props)}></this.Delete>
            }]
        };
    }
    ...
    deleteAlbum(albumUid) {
        let modalContent = (
			<div className="common-modal">
				...
				<p className="common-modal-content">After click OK, this album will be removed.</p>
			</div>
        );
        let modalHeader = (
            <div>
    ...
    clickYes = (albumUid) => {
		userService.deleteAlbum(albumUid)
			.then(data => {
    ...
    loadAlbumList() {
        userService.loadALbumList(this.props.match.params.userid).then(data => {
            if (data.errorMsg) {
                                ...
                                <Container fluid >
                                    ...
                                    <Card>
                                        <CardHeader>
                                            <Row>
                                                <Col md={4}>
                                                    <i className="fa fa-align-justify"></i> Album <small className="text-muted">List</small>
                                                </Col>
                                                <br />
